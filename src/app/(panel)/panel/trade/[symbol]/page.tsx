...
import { JoinMarketProvider } from "@/context/feature/market/JoinMarketProvider";

async function page(props: PageProps<`/panel/trade/[symbol]`>) {
  const symbol = (await props.params).symbol;

  return (
    <>
      {/* // * One Symbol Subscriber */}
      <JoinMarketProvider symbol={symbol} />
      {/* // * One Symbol Subscriber */}

      {/* // *Order Book Listener */}
      <OrderBookSyncProvider symbol={symbol} />
      {/* // *Order Book Listener */}
      <Page>
        <Header>
          <PageHeader
