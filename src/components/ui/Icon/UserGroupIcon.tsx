...
function UserGroupIcon(props: SvgIconProps) {
  return (
    <SvgIcon
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        d="M3 19H1V18C1 16.1362 2.27477 14.5701 4 14.126"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      <path
        d="M10 14H14C16.2091 14 18 15.7909 18 18V19H6V18C6 15.7909 7.79086 14 10 14Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
